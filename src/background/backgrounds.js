...
function Backgrounds() {
  ...
  const updateBackground = (
    move, fight, shoot, lethality, defence, attacks, wounds, courage, might, will, fate, athletics, finesse, practise, cleverness, charisma, erudition, wargear, knownWargear, adept, points, valid, specialRules, heroicActions, modal
  ) => {
    const params = {
      move, fight, shoot, lethality, defence, attacks, wounds, courage, might, will, fate, athletics, finesse, practise, cleverness, charisma, erudition, wargear, knownWargear, adept, points, valid, specialRules, heroicActions
    };
    params['magicalPowers'] = {}
  ...
  function updateBackgroundRequest(params) {
    const {
      move, fight, shoot, lethality, defence, attacks, wounds, courage,
  ...
  const shuffledArray = getRandomArrayWithSeed(id);
  ...
  return (
    <>
      ...
      <BackgroundModal showModal={showModal} modalType={modalType} replaceWeapon={replaceWeapon} replaceWeaponCategory={replaceWeaponCategory} closeModal={closeModal} />
    </>
  );
};
